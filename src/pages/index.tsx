            ...
            <div className="row">
              <div className="col col--12  margin-top--md">
                <div style={{ textAlign: 'center' }}>
                  ...
                  >
                    <img
                      src={useBaseUrl('img/trmnl-iphone-apple-watch.jpg')}
                      alt="TRMNL, Apple Watch and iPhone displaying Rigs being generated by Slipway"
                      style={{
                        width: '100%',
                        height: 'auto',
                        borderRadius: '8px',
                  ...
                  <div style={{ marginTop: '0.5rem', color: '#666', fontSize: '1rem' }}>
                    <Link to="/docs/using-with-trmnl/slipway-for-trmnl-devices">TRMNL</Link> showing <Link to="https://github.com/jamesthurley/slipway_givenergy_cloud">house Solar, Battery and Power usage.</Link><br/>
                    Apple Watch displaying <Link to="https://github.com/jamesthurley/slipway_github_commit_graph">20 day GitHub commit graph.</Link><br/>
                    iPhone displaying both <Link to="https://github.com/jamesthurley/slipway_github_commit_graph">26 day GitHub commit graph</Link> and <Link to="https://github.com/jamesthurley/slipway_givenergy_cloud">house Solar, Battery and Power usage.</Link>.<br/>
